...
const Signup = () => {
  ...
  const { name, cid, email, mobile, gender, status, password, confirmPassword, termsAccepted } = formData;
  ...
  const handleSubmit = (event) => {
    ...
    if (!name || !cid || !email || !mobile || !gender || !status || !password || !confirmPassword || !termsAccepted) {
