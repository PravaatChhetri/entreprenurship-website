    ...
    <div className="mb-10">
            ...
            <p className="text-gray-700 text-xl">
              <ul className="list-disc list-inside flex flex-col gap-y-[15px]">
                <li>
                  ...
                  mentorship, and support they need to thrive and make a
                  positive impact.
                </li>
                <li>
                ...
                <li>
                  <span className="font-bold">Driving Innovation:</span> We
                  drive innovation by encouraging the development and adoption
                  of cutting-edge technologies and disruptive ideas.
                </li>
                <li>
          ...
          <div className="min-w-xl max-w-[80vw] bg-white shadow-md rounded-lg p-6 mx-auto">
            <p className="text-gray-700 text-xl">
              <ul className="list-disc list-inside flex flex-col gap-y-[15px]">
                ...
                <li>
                  <span className="font-bold">Code of Conduct:</span> We uphold
                  a code of conduct that promotes professionalism, respect, and
        ...
        <div className="flex justify-left">
          <div className="min-w-xl max-w-[80vw] bg-white shadow-md rounded-lg p-6 mx-auto">
            <p className="text-gray-700 text-xl">
              <ul className="list-disc list-inside flex flex-col gap-y-[15px]">
                <li>
                  <span className="font-bold">Empowering Entrepreneurs:</span>{" "}
                  We are dedicated to empowering entrepreneurs by providing them
                  with the necessary resources, guidance, and support to succeed
                  in their ventures.
                </li>
                <li>
                  <span className="font-bold">Fostering Collaboration:</span> We
                  believe in the power of collaboration and actively facilitate
                  connections among startups, mentors, investors, and industry
                  experts to foster a thriving entrepreneurial community.
                </li>
                <li>
                  <span className="font-bold">Promoting Innovation:</span> We
                  encourage and support innovative ideas and technologies that
                  have the potential to create positive change and drive
                  economic growth.
                </li>
                <li>
                  <span className="font-bold">
                  ...
                  We value diversity and inclusivity and strive to create an
                  environment where individuals from all backgrounds feel
                  welcome and have equal opportunities.
                </li>
                <li>
                  <span className="font-bold">
                    Advocating for Supportive Policies:
                  </span>{" "}
                  We advocate for policies and regulations that create a
                  favorable ecosystem for startups, enabling them to thrive and
                  make a meaningful impact on the economy and society.
                </li>
                <li>
                  <span className="font-bold">
                    Promoting Sustainable Practices:
                  </span>{" "}
                  We promote sustainable business practices among startups,
                  encouraging them to consider social and environmental impacts
      ...
      <div className="relative container mx-auto mt-8">
        ...
        <div className="flex justify-left">
          <div className="min-w-xl max-w-[80vw] bg-white shadow-md rounded-lg p-6 mx-auto">
            <p className="text-gray-700 text-xl">
            The Department of Employment and Entrepreneurship (DoEE) is a government organization dedicated to fostering 
            entrepreneurship and promoting employment opportunities. With a strong focus on supporting startups and small 
            businesses, DoEE provides valuable resources, mentorship, and guidance to aspiring entrepreneurs. By facilitating 
            access to funding, offering business development programs, and creating an enabling ecosystem, DoEE plays a crucial 
            role in nurturing a thriving entrepreneurial landscape.
            {" "}
            </p>
            <br/>
            <p className="text-gray-700 text-xl">
            The Entrepreneurship Promotion Division (EPD) is a key division within DoEE, responsible for driving initiatives that 
            encourage and support entrepreneurship. EPD focuses on creating an ecosystem conducive to startup growth, fostering 
            innovation, and providing platforms for knowledge sharing and collaboration. Through targeted programs, events, and 
            partnerships, EPD plays a vital role in connecting entrepreneurs with mentors, investors, and industry experts, enabling 
            them to realize their entrepreneurial aspirations and contribute to economic development.
            {" "}
            </p>
          </div>
        </div>
